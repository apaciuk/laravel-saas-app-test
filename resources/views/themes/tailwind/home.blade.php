      ...
      <div class="w-full md:w-1/2 md:px-3">
        <div class="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
          <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
            ...
            <span class="block text-pink-700 xl:inline">Tell Your Story!</span>
          </h1>
          ...
          <div class="relative flex flex-col sm:flex-row sm:space-x-4">
            <a href="#_" class="flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-pink-700 rounded-md sm:mb-0 hover:bg-pink-800 sm:w-auto">
              Try It Free
    ...
    <div class="max-w-6xl px-12 mx-auto bg-gray-100 md:px-16 xl:px-10">
        <div class="flex flex-col items-center lg:flex-row">
            <div class="flex flex-col items-start justify-center w-full h-full pr-8 mb-10 lg:mb-0 lg:w-1/2">
                <p class="mb-2 text-base font-medium tracking-tight text-pink-700 uppercase">Our customers love our product</p>
                ...
                <a href="#_" class="flex items-center justify-center px-8 py-3 text-base font-medium leading-6 text-white transition duration-150 ease-in-out bg-pink-700 border border-transparent rounded-md shadow hover:bg-pink-600 focus:outline-none focus:border-pink-800 focus:shadow-pink-NaN md:py-4 md:text-lg md:px-10">View Case Studies</a>
            </div>
            <div class="w-full lg:w-1/2">
                <blockquote class="flex items-center justify-between w-full col-span-1 p-6 bg-white rounded-lg shadow">
                    <div class="flex flex-col pr-8">
                        <div class="relative pl-12">
                            <svg class="absolute left-0 w-10 h-10 text-pink-700 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 125">
...
<section class="box-border py-8 leading-7 text-gray-900 bg-white border-0 border-gray-200 border-solid sm:py-12 md:py-16 lg:py-24">
    <div class="box-border max-w-6xl px-4 pb-12 mx-auto border-solid sm:px-6 md:px-6 lg:px-4">
        ...
        <div class="grid max-w-md mx-auto mt-6 overflow-hidden leading-7 text-gray-900 border border-b-4 border-gray-300 border-pink-700 rounded-xl md:max-w-lg lg:max-w-none sm:mt-10 lg:grid-cols-3">
            <div class="box-border px-4 py-8 mb-6 text-center bg-white border-solid lg:mb-0 sm:px-4 sm:py-8 md:px-8 md:py-12 lg:px-10">
                ...
                <button class="inline-flex items-center justify-center w-full py-3 mt-6 font-sans text-sm leading-none text-center text-pink-700 no-underline bg-transparent border border-b-2 border-pink-700 rounded-md cursor-pointer hover:bg-pink-700 hover:border-pink-700 hover:text-white sm:text-base sm:mt-8 md:text-lg">
                    Select Plan
                </button>
            </div>
            <div class="box-border px-4 py-8 mb-6 text-center bg-gray-100 border border-gray-300 border-solid lg:mb-0 sm:px-4 sm:py-8 md:px-8 md:py-12 lg:px-10">
                ...
                <button class="inline-flex items-center justify-center w-full py-3 mt-6 font-sans text-sm leading-none text-center text-white no-underline bg-pink-700 border-b-4 border-pink-800 rounded cursor-pointer hover:text-white sm:text-base sm:mt-8 md:text-lg">
                    Select Plan
                </button>
            </div>
            <div class="box-border px-4 py-8 text-center bg-white border-solid sm:px-4 sm:py-8 md:px-8 md:py-12 lg:px-10">
                ...
                <button class="inline-flex items-center justify-center w-full py-3 mt-6 font-sans text-sm leading-none text-center text-pink-700 no-underline bg-transparent border border-b-2 border-pink-700 rounded cursor-pointer hover:bg-pink-700 hover:border-pink-700 hover:text-white sm:text-base sm:mt-8 md:text-lg">
                    Select Plan
                </button>
            </div>
        </div>
    ...
    <div class="px-8 mx-auto max-w-7xl lg:px-16">
        ...
        <div class="grid grid-cols-1 gap-0 text-gray-600 md:grid-cols-2 md:gap-16">
            <div>
                ...
                <p>
                    You can upgrade your account by visiting <a href="https://devdojo.com/pro" class="text-pink-700 underline">The Pro Upgrade Page</a>. You will also gain access to many other applications and sections of the site.
            ...
            <div>
                ...
                <p>If you need assistance implementing the templates into your project you can contact support or you can visit our <a href="https://devdojo.com/questions" class="text-pink-700 underline">question section</a>.
                </p>
            </div>
        </div>
    </div>
...
<section class="py-8 leading-7 text-gray-900 bg-white sm:py-12 md:py-16 lg:py-24">
    <div class="max-w-6xl px-4 px-10 mx-auto border-solid lg:px-12">
        <div class="flex flex-col items-start leading-7 text-gray-900 border-0 border-gray-200 lg:items-center lg:flex-row">
            ...
            <a href="#_" class="inline-flex items-center justify-center w-full px-5 py-4 mt-6 ml-0 font-sans text-base leading-none text-white no-underline bg-pink-700 border border-pink-700 border-solid rounded cursor-pointer md:w-auto lg:mt-0 hover:bg-pink-800 hover:border-pink-800 hover:text-white focus-within:bg-pink-800 focus-within:border-pink-800 focus-within:text-white sm:text-lg lg:ml-6 md:text-xl">
                Get Started
